...
GetTestPredDT(test_pred_raw, "test_diff_LASSO",   "test_pred_ALL_LASSO")
GetTestPredDT(test_pred_raw, "test_diff_SVM",   "test_pred_ALL_SVM")
GetTestPredDT(test_pred_raw, "test_diff_SVM_RBF",   "test_pred_ALL_SVM_RBF")
GetTestPredDT(test_pred_raw, "test_diff_RF",   "test_pred_ALL_RF")
